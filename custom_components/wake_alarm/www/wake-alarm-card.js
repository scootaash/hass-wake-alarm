...
`,_t=["mon","tue","wed","thu","fri","sat","sun"],gt={d1_mon:"mon",d2_tue:"tue",d3_wed:"wed",d4_thu:"thu",d5_fri:"fri",d6_sat:"sat",d7_sun:"sun"},vt=["length_min","start_kelvin","target_kelvin","max_brightness_pct","volume","snooze_min","steps_per_min","music_fade_sec","auto_dismiss_min"],ft=["test_light_ramp","cancel_ramp","test_music","test_standard_notification","test_urgent_notification","dismiss","snooze"],bt=["next_alarm","state","media_selection"];class yt extends Error{}let $t=class extends nt{constructor(){super(...arguments),this._cancelRamp=()=>{this.hass&&this.related&&this.hass.callService("button","press",{entity_id:this.related.buttons.cancel_ramp})},this._toggleEnabled=()=>{this.hass&&this.related&&this.hass.callService("switch","toggle",{entity_id:this.related.enabled})},this._handleModeTileClick=()=>{if(!this.hass||!this.related)return;const t=this.hass.states[this.related.sensors.state]?.state;t&&"idle"!==t||this._toggleEnabled()},this._snooze=()=>{this.hass&&this.related&&this.hass.callService("button","press",{entity_id:this.related.buttons.snooze})},this._dismiss=()=>{this.hass&&this.related&&this.hass.callService("button","press",{entity_id:this.related.buttons.dismiss})},this._goSettings=()=>{this.dispatchEvent(new CustomEvent("navigate-settings",{bubbles:!0,composed:!0}))}}disconnectedCallback(){super.disconnectedCallback(),this._stopTicker()}updated(){"snoozing"===(this.hass&&this.related?this.hass.states[this.related.sensors.state]?.state:void 0)?this._startTicker():this._stopTicker()}_startTicker(){void 0===this._tickInterval&&(this._tickInterval=window.setInterval(()=>this.requestUpdate(),1e3))}_stopTicker(){void 0!==this._tickInterval&&(window.clearInterval(this._tickInterval),this._tickInterval=void 0)}render(){if(!this.hass||!this.related)return q``;const t=this.related,e=this.hass.states[t.enabled],i=this.hass.states[t.sensors.state],s=this.hass.states[t.active],a=this.hass.states[t.alarmTime],o=this.hass.states[t.sensors.next_alarm],r="on"===e?.state,n=i?.state??"idle",l="on"===s?.state,c=kt(a?.state),d=wt[n]??wt.idle,h=r?function(t){switch(t){case"ramping":return"Ramping";case"playing":return"Playing";case"snoozing":return"Snoozing";default:return"On"}}(n):"Off",p=i?.attributes?.snooze_until,u="snoozing"===n&&p?function(t){const e=new Date(t).getTime();if(Number.isNaN(e))return t;const i=Math.max(0,Math.round((e-Date.now())/1e3)),s=Math.floor(i/60);return`${s}:${At(i%60)}`}(p):null,m=u?`Music in ${u}`:o?.state&&"unknown"!==o.state?function(t){const e=new Date(t);if(Number.isNaN(e.getTime()))return t;const i={weekday:"short",hour:"2-digit",minute:"2-digit",hour12:!1};return new Intl.DateTimeFormat(void 0,i).format(e)}(o.state):"No upcoming alarm";return q`
    ...
    `}_renderDayChip(t){if(!this.hass||!this.related)return q``;const e=this.related.days[t],i="on"===this.hass.states[e]?.state;return q`
      <div
    ...
    `}_renderActiveActions(t){return q`
    ...
    `],t([pt({attribute:!1})],$t.prototype,"hass",void 0),t([pt({attribute:!1})],$t.prototype,"related",void 0),$t=t([ct("wake-alarm-main-view")],$t);const wt={idle:"mdi:alarm",ramping:"mdi:weather-sunset-up",playing:"mdi:music-note",snoozing:"mdi:alarm-snooze",off:"mdi:alarm-off"},xt={mon:"Mon",tue:"Tue",wed:"Wed",thu:"Thu",fri:"Fri",sat:"Sat",sun:"Sun"};function kt(t){if(!t)return{h:7,m:0};const e=/^(\d{1,2}):(\d{1,2})/.exec(t);return e?{h:parseInt(e[1],10),m:parseInt(e[2],10)}:{h:7,m:0}}function At(t){return t.toString().padStart(2,"0")}let Et=class extends nt{constructor(){super(...arguments),this.icon="mdi:music",this._failed=!1,this._resolving=!1,this._onError=()=>{this._failed=!0}}willUpdate(t){switch(e=this.thumbnail,i=this._resolvedFor,e?e===i?"none":"resolve":i?"clear":"none"){case"resolve":this.hass&&!this._resolving&&this._resolve();break;case"clear":this._resolvedFor=void 0,this._src=void 0,this._failed=!1}var e,i}async _resolve(){const t=this.thumbnail;if(t&&this.hass){this._resolving=!0,this._resolvedFor=t,this._failed=!1;try{const e=await async function(t,e){let i=e;if(/^https?:\/\//i.test(e)){let t;try{t=new URL(e)}catch{return e}if(!t.pathname.startsWith("/api/"))return e;i=t.pathname+t.search}else if(!e.startsWith("/"))return e;try{return(await t.callWS({type:"auth/sign_path",path:i})).path}catch{return i}}(this.hass,t);this.thumbnail===t&&(this._src=e)}finally{this._resolving=!1}}}render(){return this._src&&!this._failed?q`<img
        src=${this._src}
        alt=""
        loading="lazy"
        @error=${this._onError}
  ...
  `,t([pt({attribute:!1})],Et.prototype,"hass",void 0),t([pt({attribute:!1})],Et.prototype,"thumbnail",void 0),t([pt()],Et.prototype,"icon",void 0),t([ut()],Et.prototype,"_src",void 0),t([ut()],Et.prototype,"_failed",void 0),Et=t([ct("wake-alarm-thumb")],Et);let St=class extends nt{constructor(){super(...arguments),this._children=[],this._path=[],this._loading=!1}firstUpdated(){this._navigate(void 0,void 0,"Library")}async _navigate(t,e,i){if(this.hass&&this.entityId){this._loading=!0,this._error=void 0;try{const s={type:"media_player/browse_media",entity_id:this.entityId,...void 0!==t?{media_content_id:t}:{},...void 0!==e?{media_content_type:e}:{}},a=await this.hass.callWS(s);this._children=a.children??[],this._path=[...this._path,{contentId:t,contentType:e,title:a.title||i}]}catch(t){this._error=`${t}`}finally{this._loading=!1}}}async _back(){if(this._path.length<=1)return;const t=this._path.slice(0,-1),e=t[t.length-1];this._path=t.slice(0,-1),await this._navigate(e.contentId,e.contentType,e.title)}_onItemClick(t){if(t.can_expand)this._navigate(t.media_content_id,t.media_content_type,t.title);else if(t.can_play){const e={media_content_id:t.media_content_id,media_content_type:t.media_content_type,title:t.title,thumbnail:t.thumbnail??void 0};this.dispatchEvent(new CustomEvent("media-picked",{detail:{item:e},bubbles:!0,composed:!0}))}}render(){const t=this._path.map(t=>t.title).join(" › ")||"Library";return q`
      <div class="toolbar">
        <button
          class="back"
      ...
      ${this._error?q`<div class="error">Failed to browse: ${this._error}</div>`:null}
      ${this._loading?q`<div class="loading">Loading…</div>`:q`
            <div class="grid">
              ${0===this._children.length?q`<div class="empty">Nothing to show.</div>`:this._children.map(t=>this._renderItem(t))}
            </div>
          `}
    `}_renderItem(t){const e=!!t.can_play,i=!!t.can_expand;return q`
  ...
  `,t([pt({attribute:!1})],St.prototype,"hass",void 0),t([pt()],St.prototype,"entityId",void 0),t([ut()],St.prototype,"_children",void 0),t([ut()],St.prototype,"_path",void 0),t([ut()],St.prototype,"_loading",void 0),t([ut()],St.prototype,"_error",void 0),St=t([ct("wake-alarm-media-browser")],St);const Ct=[{key:"snooze_min",label:"Snooze (min)",description:"How long the snooze pause lasts before music resumes.",min:1,max:30,step:1},{key:"length_min",label:"Length (min)",description:"Total minutes the lights ramp up before the alarm time.",min:1,max:120,step:1},{key:"start_kelvin",label:"Start K",description:"Warm colour temperature at the beginning of the ramp.",min:1500,max:6500,step:50},{key:"target_kelvin",label:"Target K",description:"Cool colour temperature reached at the alarm time.",min:1500,max:6500,step:50},{key:"max_brightness_pct",label:"Max % Brightness",description:"Peak brightness reached at the alarm time.",min:1,max:100,step:1},{key:"volume",label:"Alarm Volume (%)",description:"Final volume the music fades up to. Defaults to a low value so test plays don't blast.",min:0,max:100,step:1,displayMultiplier:100},{key:"music_fade_sec",label:"Music fade (s)",description:"How long the volume takes to fade from 0 to the target volume.",min:0,max:300,step:5},{key:"auto_dismiss_min",label:"Auto-dismiss (min)",description:"Stop everything this long after the music starts (the alarm time) — not the start of the light ramp. 0 disables.",min:0,max:120,step:1}];let Pt=class extends nt{constructor(){super(...arguments),this._showMediaPicker=!1,this._openMediaPicker=()=>{this._showMediaPicker=!0},this._closeMediaPicker=()=>{this._showMediaPicker=!1},this._onMediaPicked=t=>{if(!this.hass||!this.related)return;const e=t.detail?.item;e&&(this.hass.callService("wake_alarm","set_media",{media_content_id:e.media_content_id,media_content_type:e.media_content_type,title:e.title??e.media_content_id,thumbnail:e.thumbnail},{entity_id:this.related.enabled}),this._closeMediaPicker())},this._openOptionsFlow=()=>{this.related&&(history.pushState(null,"","/config/integrations/integration/wake_alarm"),window.dispatchEvent(new Event("location-changed")))},this._goBack=()=>{this.dispatchEvent(new CustomEvent("navigate-back",{bubbles:!0,composed:!0}))}}shouldUpdate(t){return t.has("hass")||t.has("related")||t.has("_showMediaPicker")}render(){if(!this.hass||!this.related)return q``;const t=this.related,e=this.hass.states[t.sensors.state]?.state??"idle",i=this.hass.states[t.sensors.media_selection],s=i?.state??"none",a="none"!==s,o=i?.attributes?.thumbnail,r=this.hass.states[t.sensors.next_alarm],n=r?.attributes?.light_entities??[],l=r?.attributes?.media_player_entities??[],c=r?.attributes?.person_entity,d=function(t){return!!t&&t.length>0}(l);return q`
      <ha-card>
        ...
        <div class="section actions">
          ...
          ${"ramping"===e?q`<button class="btn" @click=${()=>this._press("cancel_ramp")}>
                Cancel ramp
              </button>`:null}
    ...
    `}_renderSlider(t){if(!this.hass||!this.related)return q``;const e=this.related.numbers[t.key],i=this.hass.states[e]?.state,s=i&&!["unknown","unavailable"].includes(i)?Number(i):t.min/(t.displayMultiplier??1),a=t.displayMultiplier??1,o=s*a,r=t.step>=1?o.toFixed(0):o.toFixed(2);return q`
    ...
    `],t([pt({attribute:!1})],Pt.prototype,"hass",void 0),t([pt({attribute:!1})],Pt.prototype,"related",void 0),t([ut()],Pt.prototype,"_showMediaPicker",void 0),Pt=t([ct("wake-alarm-settings-view")],Pt);let Mt=class extends nt{constructor(){super(...arguments),this._enabledSwitches=[],this._onEntityChange=t=>{const e=t.target.value,i={...this._config??{type:"custom:wake-alarm-card"},entity:e};this._config=i,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:i},bubbles:!0,composed:!0}))}}setConfig(t){this._config=t}firstUpdated(){this._loadEnabledSwitches()}async _loadEnabledSwitches(){if(this.hass)try{const t=await this.hass.callWS({type:"config/entity_registry/list"});if(this._enabledSwitches=t.filter(t=>"wake_alarm"===t.platform&&(t.unique_id??"").endsWith("_enabled")&&t.entity_id.startsWith("switch.")).map(t=>t.entity_id).sort(),this._config?.entity&&!this._enabledSwitches.includes(this._config.entity)){const t={...this._config,entity:""};this._config=t,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}}catch(t){this._loadError=`${t}`}}render(){return this._config?this._loadError?q`<div class="error">Failed to load wake_alarm entities: ${this._loadError}</div>`:q`
      <div class="row">
        ...
        >
          ...
          ${this._enabledSwitches.map(t=>q`<option value=${t} ?selected=${this._config.entity===t}>${t}</option>`)}
        </select>
      </div>
      ${0===this._enabledSwitches.length?q`<div class="hint">
            No wake_alarm instances yet. Add one in
            Settings → Devices &amp; Services → Add Integration → Wake Alarm.
          </div>`:null}
    `:q``}};var Tt;Mt.styles=r`
    ...
    .error { color: var(--error-color, rgb(255, 82, 82)); }
  `,t([pt({attribute:!1})],Mt.prototype,"hass",void 0),t([ut()],Mt.prototype,"_config",void 0),t([ut()],Mt.prototype,"_enabledSwitches",void 0),t([ut()],Mt.prototype,"_loadError",void 0),Mt=t([ct("wake-alarm-card-editor")],Mt);let zt=Tt=class extends nt{constructor(){super(...arguments),this._view="main",this._resolving=!1,this._resolveAttempts=0,this._goMain=()=>{this._view="main"},this._goSettings=()=>{this._view="settings"}}setConfig(t){if(t?.entity&&!t.entity.startsWith("switch."))throw new Error("wake-alarm-card: `entity` must be a switch (the wake_alarm enabled switch).");this._config=t??{type:"custom:wake-alarm-card",entity:""},this._related=void 0,this._resolveError=void 0,this._resolving=!1,this._resolveAttempts=0}getCardSize(){return 6}static getConfigElement(){return document.createElement("wake-alarm-card-editor")}static async getStubConfig(t){if(!t)return{type:"custom:wake-alarm-card",entity:""};try{const e=(await t.callWS({type:"config/entity_registry/list"})).find(t=>"wake_alarm"===t.platform&&(t.unique_id??"").endsWith("_enabled")&&(t.entity_id??"").startsWith("switch."));return{type:"custom:wake-alarm-card",entity:e?.entity_id??""}}catch{return{type:"custom:wake-alarm-card",entity:""}}}willUpdate(t){this.hass&&this._config?.entity&&!this._related&&!this._resolving&&this._resolveAttempts<Tt._MAX_RESOLVE_ATTEMPTS&&(t.has("hass")||t.has("_config"))&&this._resolveRelated()}async _resolveRelated(){if(this.hass&&this._config){this._resolving=!0,this._resolveAttempts+=1;try{const t=await this.hass.callWS({type:"config/entity_registry/list"});this._related=function(t,e){const i=e.find(e=>e.entity_id===t);if(!i)throw new yt(`Entity ${t} is not in the entity registry.`);if("wake_alarm"!==i.platform)throw new yt(`Entity ${t} is not a wake_alarm entity (platform=${i.platform}).`);const s=i.config_entry_id;if(!s)throw new yt(`Entity ${t} has no config_entry_id.`);const a={},o={},r=`${s}_`;for(const t of e){if(t.config_entry_id!==s)continue;if(!t.unique_id||!t.unique_id.startsWith(r))continue;const e=t.unique_id.slice(r.length),i=gt[e];i?o[i]=t.entity_id:a[e]=t.entity_id}const n=t=>{const e=a[t];if(!e)throw new yt(`Wake Alarm entity for "${t}" is missing from the registry. Make sure the integration is fully loaded.`);return e};for(const t of _t)if(!o[t])throw new yt(`Wake Alarm day toggle for "${t}" is missing from the registry. Make sure the integration is fully loaded and migrated to v2+.`);const l={};for(const t of vt)l[t]=n(t);const c={};for(const t of ft)c[t]=n(t);const d={};for(const t of bt)d[t]=n(t);return{configEntryId:s,enabled:n("enabled"),active:n("active"),alarmTime:n("alarm_time"),days:o,numbers:l,buttons:c,sensors:d}}(this._config.entity,t),this._resolveError=void 0}catch(t){this._resolveError=t instanceof yt?t.message:`Could not resolve wake_alarm entities: ${t}`}finally{this._resolving=!1}}}render(){return this._config?this._config.entity?this._resolveError?q`<ha-card><div class="error">${this._resolveError}</div></ha-card>`:this._related&&this.hass?"settings"===this._view?q`
        ...
        `:q`
          ...
          ></wake-alarm-main-view>
        `:q`<ha-card><div class="loading">Loading…</div></ha-card>`:q`<ha-card><div class="loading">
        Pick a Wake Alarm enabled-switch in the visual editor.
      </div></ha-card>`:q``}};zt._MAX_RESOLVE_ATTEMPTS=10,zt.styles=mt,t([pt({attribute:!1})],zt.prototype,"hass",void 0),t([ut()],zt.prototype,"_config",void 0),t([ut()],zt.prototype,"_view",void 0),t([ut()],zt.prototype,"_related",void 0),t([ut()],zt.prototype,"_resolveError",void 0),zt=Tt=t([ct("wake-alarm-card")],zt),window.customCards=window.customCards??[],window.customCards.push({type:"wake-alarm-card",name:"Wake Alarm",description:"Wake-up alarm with a gradual light ramp and a music sequence.",preview:!1}),console.info("%c WAKE-ALARM-CARD %c v0.5.0 ","color: white; background: #ff5722; font-weight: 700;","color: #ff5722; background: white; font-weight: 700;");export{zt as WakeAlarmCard};
