...
`,_t=["mon","tue","wed","thu","fri","sat","sun"],gt={d1_mon:"mon",d2_tue:"tue",d3_wed:"wed",d4_thu:"thu",d5_fri:"fri",d6_sat:"sat",d7_sun:"sun"},vt=["length_min","start_kelvin","target_kelvin","max_brightness_pct","volume","snooze_min","steps_per_min","music_fade_sec","auto_dismiss_min"],ft=["test_light_ramp","cancel_ramp","test_music","test_standard_notification","test_urgent_notification","dismiss","snooze"],bt=["next_alarm","state","media_selection"];class yt extends Error{}let $t=class extends nt{constructor(){super(...arguments),this._cancelRamp=()=>{this.hass&&this.related&&this.hass.callService("button","press",{entity_id:this.related.buttons.cancel_ramp})},this._toggleEnabled=()=>{this.hass&&this.related&&this.hass.callService("switch","toggle",{entity_id:this.related.enabled})},this._handleModeTileClick=()=>{if(!this.hass||!this.related)return;const t=this.hass.states[this.related.sensors.state]?.state;t&&"idle"!==t||this._toggleEnabled()},this._snooze=()=>{this.hass&&this.related&&this.hass.callService("button","press",{entity_id:this.related.buttons.snooze})},this._dismiss=()=>{this.hass&&this.related&&this.hass.callService("button","press",{entity_id:this.related.buttons.dismiss})},this._goSettings=()=>{this.dispatchEvent(new CustomEvent("navigate-settings",{bubbles:!0,composed:!0}))}}disconnectedCallback(){super.disconnectedCallback(),this._stopTicker()}updated(){"snoozing"===(this.hass&&this.related?this.hass.states[this.related.sensors.state]?.state:void 0)?this._startTicker():this._stopTicker()}_startTicker(){void 0===this._tickInterval&&(this._tickInterval=window.setInterval(()=>this.requestUpdate(),1e3))}_stopTicker(){void 0!==this._tickInterval&&(window.clearInterval(this._tickInterval),this._tickInterval=void 0)}render(){if(!this.hass||!this.related)return q``;const t=this.related,e=this.hass.states[t.enabled],i=this.hass.states[t.sensors.state],s=this.hass.states[t.active],a=this.hass.states[t.alarmTime],o=this.hass.states[t.sensors.next_alarm],r="on"===e?.state,n=i?.state??"idle",c="on"===s?.state,l=kt(a?.state),d=wt[n]??wt.idle,h=r?function(t){switch(t){case"ramping":return"Ramping";case"playing":return"Playing";case"snoozing":return"Snoozing";default:return"On"}}(n):"Off",p=i?.attributes?.snooze_until,u="snoozing"===n&&p?function(t){const e=new Date(t).getTime();if(Number.isNaN(e))return t;const i=Math.max(0,Math.round((e-Date.now())/1e3)),s=Math.floor(i/60);return`${s}:${At(i%60)}`}(p):null,m=u?`Music in ${u}`:o?.state&&"unknown"!==o.state?function(t){const e=new Date(t);if(Number.isNaN(e.getTime()))return t;const i={weekday:"short",hour:"2-digit",minute:"2-digit",hour12:!1};return new Intl.DateTimeFormat(void 0,i).format(e)}(o.state):"No upcoming alarm";return q`
    ...
    `],t([pt({attribute:!1})],$t.prototype,"hass",void 0),t([pt({attribute:!1})],$t.prototype,"related",void 0),$t=t([lt("wake-alarm-main-view")],$t);const wt={idle:"mdi:alarm",ramping:"mdi:weather-sunset-up",playing:"mdi:music-note",snoozing:"mdi:alarm-snooze",off:"mdi:alarm-off"},xt={mon:"Mon",tue:"Tue",wed:"Wed",thu:"Thu",fri:"Fri",sat:"Sat",sun:"Sun"};function kt(t){if(!t)return{h:7,m:0};const e=/^(\d{1,2}):(\d{1,2})/.exec(t);return e?{h:parseInt(e[1],10),m:parseInt(e[2],10)}:{h:7,m:0}}function At(t){return t.toString().padStart(2,"0")}let Et=class extends nt{constructor(){super(...arguments),this.icon="mdi:music",this._failed=!1,this._onError=()=>{this._failed=!0}}willUpdate(t){(t.has("thumbnail")||t.has("hass"))&&this._resolve()}async _resolve(){const t=this.thumbnail;if(this._failed=!1,this._src=void 0,!t||!this.hass)return;const e=await async function(t,e){let i=e;if(/^https?:\/\//i.test(e)){let t;try{t=new URL(e)}catch{return e}if(!t.pathname.startsWith("/api/"))return e;i=t.pathname+t.search}else if(!e.startsWith("/"))return e;try{return(await t.callWS({type:"auth/sign_path",path:i})).path}catch{return i}}(this.hass,t);this.thumbnail===t&&(this._src=e)}render(){return this._src&&!this._failed?q`<img
        src=${this._src}
        alt=""
        loading="lazy"
        @error=${this._onError}
  ...
  `,t([pt({attribute:!1})],Mt.prototype,"hass",void 0),t([ut()],Mt.prototype,"_config",void 0),t([ut()],Mt.prototype,"_enabledSwitches",void 0),t([ut()],Mt.prototype,"_loadError",void 0),Mt=t([lt("wake-alarm-card-editor")],Mt);let zt=class extends nt{constructor(){super(...arguments),this._view="main",this._goMain=()=>{this._view="main"},this._goSettings=()=>{this._view="settings"}}setConfig(t){if(t?.entity&&!t.entity.startsWith("switch."))throw new Error("wake-alarm-card: `entity` must be a switch (the wake_alarm enabled switch).");this._config=t??{type:"custom:wake-alarm-card",entity:""},this._related=void 0,this._resolveError=void 0}getCardSize(){return 6}static getConfigElement(){return document.createElement("wake-alarm-card-editor")}static async getStubConfig(t){if(!t)return{type:"custom:wake-alarm-card",entity:""};try{const e=(await t.callWS({type:"config/entity_registry/list"})).find(t=>"wake_alarm"===t.platform&&(t.unique_id??"").endsWith("_enabled")&&(t.entity_id??"").startsWith("switch."));return{type:"custom:wake-alarm-card",entity:e?.entity_id??""}}catch{return{type:"custom:wake-alarm-card",entity:""}}}willUpdate(t){this.hass&&this._config?.entity&&!this._related&&!this._resolveError&&this._resolveRelated()}async _resolveRelated(){if(this.hass&&this._config)try{const t=await this.hass.callWS({type:"config/entity_registry/list"});this._related=function(t,e){const i=e.find(e=>e.entity_id===t);if(!i)throw new yt(`Entity ${t} is not in the entity registry.`);if("wake_alarm"!==i.platform)throw new yt(`Entity ${t} is not a wake_alarm entity (platform=${i.platform}).`);const s=i.config_entry_id;if(!s)throw new yt(`Entity ${t} has no config_entry_id.`);const a={},o={},r=`${s}_`;for(const t of e){if(t.config_entry_id!==s)continue;if(!t.unique_id||!t.unique_id.startsWith(r))continue;const e=t.unique_id.slice(r.length),i=gt[e];i?o[i]=t.entity_id:a[e]=t.entity_id}const n=t=>{const e=a[t];if(!e)throw new yt(`Wake Alarm entity for "${t}" is missing from the registry. Make sure the integration is fully loaded.`);return e};for(const t of _t)if(!o[t])throw new yt(`Wake Alarm day toggle for "${t}" is missing from the registry. Make sure the integration is fully loaded and migrated to v2+.`);const c={};for(const t of vt)c[t]=n(t);const l={};for(const t of ft)l[t]=n(t);const d={};for(const t of bt)d[t]=n(t);return{configEntryId:s,enabled:n("enabled"),active:n("active"),alarmTime:n("alarm_time"),days:o,numbers:c,buttons:l,sensors:d}}(this._config.entity,t)}catch(t){this._resolveError=t instanceof yt?t.message:`Could not resolve wake_alarm entities: ${t}`}}render(){return this._config?this._config.entity?this._resolveError?q`<ha-card><div class="error">${this._resolveError}</div></ha-card>`:this._related&&this.hass?"settings"===this._view?q`
      ...
      </div></ha-card>`:q``}};zt.styles=mt,t([pt({attribute:!1})],zt.prototype,"hass",void 0),t([ut()],zt.prototype,"_config",void 0),t([ut()],zt.prototype,"_view",void 0),t([ut()],zt.prototype,"_related",void 0),t([ut()],zt.prototype,"_resolveError",void 0),zt=t([lt("wake-alarm-card")],zt),window.customCards=window.customCards??[],window.customCards.push({type:"wake-alarm-card",name:"Wake Alarm",description:"Wake-up alarm with a gradual light ramp and a music sequence.",preview:!1}),console.info("%c WAKE-ALARM-CARD %c v0.4.0-beta.1 ","color: white; background: #ff5722; font-weight: 700;","color: #ff5722; background: white; font-weight: 700;");export{zt as WakeAlarmCard};
